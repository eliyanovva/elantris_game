"""
Check for special characters wherever you have string input,
raise correct exception
how to test print options - printing in for loop?
    check console output buffer?
"""

import io
import unittest
from unittest.mock import patch, MagicMock
from three_classes import *
